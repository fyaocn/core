...
func TestExtractVolumes(t *testing.T) {
	...
	require.Equal(t, s.Dependencies[0].volumeKey("foo"), volumes[0].Source)
	require.Equal(t, "foo", volumes[0].Target)
	require.Equal(t, false, volumes[0].Bind)
	require.Equal(t, s.Dependencies[0].volumeKey("bar"), volumes[1].Source)
	...
	require.Len(t, volumes, 2)
	require.Equal(t, s.Dependencies[1].volumeKey("foo"), volumes[0].Source)
	require.Equal(t, "foo", volumes[0].Target)
	require.Equal(t, false, volumes[0].Bind)
	require.Equal(t, s.Dependencies[1].volumeKey("bar"), volumes[1].Source)
	require.Equal(t, "bar", volumes[1].Target)
	require.Equal(t, false, volumes[1].Bind)
}
